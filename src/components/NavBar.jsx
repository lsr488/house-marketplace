			...
			<nav className="navbarNav">
				<ul className="navbarListItems">
					...
					<li className="navbarListItems" onClick={() => navigate('/offers')}>
						<OfferIcon fill={pathMatchRoute('/offers') ? "#2c2c2c" : "#8f8f8f"} wwidth="36px" height="36px"/>
					...
					<li className="navbarListItems" onClick={() => navigate('/profile')}>
						<PersonOutlineIcon fill={pathMatchRoute('/profile') ? "#2c2c2c" : "#8f8f8f"} wwidth="36px" height="36px"/>
